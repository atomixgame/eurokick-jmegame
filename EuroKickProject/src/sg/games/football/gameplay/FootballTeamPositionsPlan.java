 ...
 */
public class FootballTeamPositionsPlan {

    HashMap<FootballPlayerInfo, Vector2D> positions = new HashMap<FootballPlayerInfo, Vector2D>();
    StadiumMaker stadium;
    SoccerPitch soccerPitch;

    public FootballTeamPositionsPlan() {

    }

    public FootballTeamPositionsPlan(FootballTeamPositionsPlan cloneObj) {
    ...
    public HashMap<FootballPlayerInfo, Vector2D> getPositions() {
        return positions;
    }
