package sg.games.football.gameplay.ai.info;
...
public class Params {
    ...
    public void load() {
        //FIXME: Slurper the config from outsite!
        ...
        PlayerKickingDistance = 0.4;

        //the number of times a player can kick the ball per second
        PlayerKickFrequency = 2;

        PlayerMass = 70.0;
        PlayerMaxForce = 1.0;
        PlayerMaxSpeedWithBall = 2.2;
        PlayerMaxSpeedWithoutBall = 3.6;
        ...
        //when the ball becomes within this distance of the goalkeeper he
        //changes state to intercept the ball
        GoalKeeperInterceptRange = 5.0;

        //how close the ball must be to a receiver before he starts chasing it
        BallWithinReceivingRange = 3.0;
