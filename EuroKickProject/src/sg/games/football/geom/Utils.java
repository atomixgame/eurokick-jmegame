...
//        return v1 > v2 ? v1 : v2;
//    }
    public static int Maximum(int v1, int v2) {
        return v1 > v2 ? v1 : v2;
    }

    public static float Maximum(float v1, float v2) {
        return v1 > v2 ? v1 : v2;
    }
...
//    }
    ...
    public static double StandardDeviation(List<Double> v) {
        ...
        for (int i = 0; i < v.size(); ++i) {
            sd += (v.get(i) - average) * (v.get(i) - average);
        }
