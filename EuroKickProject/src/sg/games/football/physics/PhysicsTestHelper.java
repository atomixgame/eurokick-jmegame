 ...
 */
package sg.games.football.physics;
...
//        floorGeometry.addControl(new RigidBodyControl(new PlaneCollisionShape(plane), 0));
    ...
    public static void createBall(Node rootNode, AssetManager assetManager, PhysicsSpace space) {
        Material material = new Material(assetManager, "Common/MatDefs/Misc/Unshaded.j3md");
        material.setTexture("ColorMap", assetManager.loadTexture("Interface/Logo/Monkey.jpg"));
        //immovable sphere with mesh collision shape
        Sphere sphere = new Sphere(8, 8, 1);
        Geometry sphereGeometry = new Geometry("Soccer ball", sphere);
        sphereGeometry.setMaterial(material);
        sphereGeometry.setLocalTranslation(1, 1, -4);
        RigidBodyControl ball = new RigidBodyControl(new SphereCollisionShape(1f), 1);
        ball.setDamping(0.1f, 0.1f);
        sphereGeometry.addControl(ball);
